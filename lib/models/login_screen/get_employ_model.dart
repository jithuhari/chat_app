...
class CorporateDetails {
    ...
    factory CorporateDetails.fromJson(Map<String, dynamic> json) => CorporateDetails(
        ...
        managers: List<Data>.from(json["managers"].map((x) => Data.fromJson(x))),
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        corporateDetails: json["corporateDetails"] == null ? null : CorporateDetails.fromJson(json["corporateDetails"]),
